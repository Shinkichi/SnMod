...
defaultproperties
{
	...
	MaximumLevel=9;7
	UserID="Local"
	ShopPerkIcons(0)=Texture'SnTex.Perk.Icon_Medic'
	ShopPerkIcons(1)=Texture'SnTex.Perk.Icon_Support'
	ShopPerkIcons(2)=Texture'SnTex.Perk.Icon_SharpShooter'
	ShopPerkIcons(3)=Texture'SnTex.Perk.Icon_Commando'
	ShopPerkIcons(4)=Texture'SnTex.Perk.Icon_Berserker'
	ShopPerkIcons(5)=Texture'SnTex.Perk.Icon_Firebug'
	ShopPerkIcons(6)=Texture'SnTex.Perk.Icon_Demolition'
	ShopPerkIcons(7)=Texture'SnTex.Perk.Icon_OffPerk'
	ShopPerkIcons(8)=Texture'SnTex.Perk.Icon_Gunslinger'
}