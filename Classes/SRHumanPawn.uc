...
defaultproperties
{
	...
	IdleChatAnim="Idle_Pipe"
     RequiredEquipment(0)="SnMod.Knife"  // Knife
     //RequiredEquipment(0)="SnMod.Claws"  // Claw
     RequiredEquipment(1)="SnMod.Single"// 9mm
     RequiredEquipment(2)="SnMod.Frag"
     RequiredEquipment(3)="SnMod.Syringe" // Syringe
     RequiredEquipment(4)="SnMod.Welder"  // Welder
