class SeekerSixRocketProjectile extends KFMod.SeekerSixRocketProjectile;
...
defaultproperties
{
	StaticMesh=StaticMesh'KF_IJC_Halloween_Weps2.seeker6_projectile'
    MyDamageType=Class'SnMod.DamTypeSeekerSixRocket'
    ImpactDamageType=Class'SnMod.DamTypeSeekerRocketImpact'

	ImpactDamage=75
    Damage=150//100
	DamageRadius=100//150
	ArmDistSquared=10000 // 2 meters

    Speed=2000.000000
    MaxSpeed=2000.000000

	ExplosionSound=Sound'KF_FY_SeekerSixSND.WEP_Seeker_Explode'
	AmbientSound=Sound'KF_FY_SeekerSixSND.WEP_Seeker_Rocket_LP'
	AmbientSoundTwo=Sound'KF_FY_SeekerSixSND.WEP_Seeker_Rocket_LP_02'
	AmbientSoundThree=Sound'KF_FY_SeekerSixSND.WEP_Seeker_Rocket_LP_03'
