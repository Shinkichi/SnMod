...
defaultproperties
{
	FriendlyName="Server Veterancy Handler V7 (Sn)"
	...
	Perks(0)="SnMod.SRVetSupportSpec"
	Perks(1)="SnMod.SRVetBerserker"
	Perks(2)="SnMod.SRVetCommando"
	Perks(3)="SnMod.SRVetFieldMedic"
	Perks(4)="SnMod.SRVetFirebug"
	Perks(5)="SnMod.SRVetSharpshooter"
	Perks(6)="SnMod.SRVetDemolitions"
	Perks(7)="SnMod.SRVetNewtralizer"
	Perks(8)="SnMod.SRVetGunslinger"
	MinPerksLevel=0
	MaxPerksLevel=25
	...
	/*
	// Medic
	TraderInventory(0)="5:SnMod.MP7MPickup"
	TraderInventory(1)="5:SnMod.BlowerThrowerPickup"
	TraderInventory(2)="5:SnMod.MP5MPickup"
	TraderInventory(3)="5:SnMod.M7A3MPickup"
	TraderInventory(4)="5:SnMod.KrissMPickup"
	// Support
	TraderInventory(5)="2:SnMod.ShotgunPickup"
	TraderInventory(6)="2:SnMod.KSGPickup"
	TraderInventory(7)="2:SnMod.BoomStickPickup"
	TraderInventory(8)="2:SnMod.BenelliPickup"
	TraderInventory(9)="2:SnMod.AA12Pickup"
	TraderInventory(10)="2:SnMod.NailGunPickup"
	TraderInventory(11)="2:SnMod.SPShotGunPickup"
	// Sharpshooter
	TraderInventory(12)="1:SnMod.DualiesPickup"
	TraderInventory(13)="1:SnMod.MK23Pickup"
	TraderInventory(14)="1:SnMod.DualMK23Pickup"
	TraderInventory(15)="1:SnMod.Magnum44Pickup"
	TraderInventory(16)="1:SnMod.Dual44MagnumPickup"
	TraderInventory(17)="1:SnMod.DeaglePickup"
	TraderInventory(18)="1:SnMod.DualDeaglePickup"
	TraderInventory(19)="3:SnMod.WinchesterPickup"
	TraderInventory(20)="3:SnMod.CrossbowPickup"
	TraderInventory(21)="3:SnMod.M14EBRPickup"
	TraderInventory(22)="3:SnMod.M99Pickup"
	TraderInventory(23)="3:SnMod.SPSniperPickup"
	// Commando
	TraderInventory(24)="4:SnMod.BullpupPickup"
	TraderInventory(25)="4:SnMod.AK47Pickup"
	TraderInventory(26)="4:SnMod.MKb42Pickup"
	TraderInventory(27)="4:SnMod.M4Pickup"
	TraderInventory(28)="4:SnMod.SCARMK17Pickup"
	TraderInventory(29)="4:SnMod.FNFAL_ACOG_Pickup"
	TraderInventory(30)="4:SnMod.ThompsonPickup"
	TraderInventory(31)="4:SnMod.SPThompsonPickup"
	TraderInventory(32)="4:SnMod.ThompsonDrumPickup"
	// Berserker
	TraderInventory(33)="0:SnMod.MachetePickup"
	TraderInventory(34)="0:SnMod.AxePickup"
	TraderInventory(35)="0:SnMod.ChainsawPickup"
	TraderInventory(36)="0:SnMod.KatanaPickup"
	TraderInventory(37)="0:SnMod.ClaymoreSwordPickup"
	TraderInventory(38)="0:SnMod.CrossbuzzsawPickup"
	TraderInventory(39)="0:SnMod.ScythePickup"
	TraderInventory(40)="0:SnMod.DwarfAxePickup"
	// Firebug
	TraderInventory(41)="7:SnMod.FlameThrowerPickup"
	TraderInventory(42)="2:SnMod.TrenchgunPickup"
	TraderInventory(43)="1:SnMod.FlareRevolverPickup"
	TraderInventory(44)="1:SnMod.DualFlareRevolverPickup"
	TraderInventory(45)="4:SnMod.MAC10Pickup"
	TraderInventory(46)="7:SnMod.HuskGunPickup"
	// Demolition
	TraderInventory(47)="6:SnMod.PipeBombPickup"
	TraderInventory(48)="6:SnMod.M79Pickup"
	TraderInventory(49)="6:SnMod.M32Pickup"
	TraderInventory(50)="4:SnMod.M4203Pickup"
	TraderInventory(51)="6:SnMod.SPGrenadePickup"
	TraderInventory(52)="6:SnMod.LAWPickup"
	TraderInventory(53)="6:SnMod.SealSquealPickup"
	TraderInventory(54)="6:SnMod.SeekerSixPickup"
	// No perk
	TraderInventory(55)="8:SnMod.ZEDGunPickup"
	TraderInventory(56)="8:SnMod.ZEDMKIIPickup"
	// Golden
	TraderInventory(57)="2:SnMod.GoldenAA12Pickup"
	TraderInventory(58)="4:SnMod.GoldenAK47Pickup"
	TraderInventory(59)="2:SnMod.GoldenBenelliPickup"
	TraderInventory(60)="0:SnMod.GoldenChainsawPickup"
	TraderInventory(61)="1:SnMod.GoldenDeaglePickup"
	TraderInventory(62)="1:SnMod.GoldenDualDeaglePickup"
	TraderInventory(63)="7:SnMod.GoldenFTPickup"
	TraderInventory(64)="0:SnMod.GoldenKatanaPickup"
	TraderInventory(65)="6:SnMod.GoldenM79Pickup"
	// Camo
	TraderInventory(66)="4:SnMod.CamoMP5MPickup"
	TraderInventory(67)="2:SnMod.CamoShotgunPickup"
	TraderInventory(68)="4:SnMod.CamoM4Pickup"
	TraderInventory(69)="6:SnMod.CamoM32Pickup"
	// Neon
	TraderInventory(70)="4:SnMod.NeonAK47Pickup"
	TraderInventory(71)="5:SnMod.NeonKrissMPickup"
	TraderInventory(72)="2:SnMod.NeonKSGPickup"
	TraderInventory(73)="4:SnMod.NeonSCARMK17Pickup"
	*/
	...
	SmileyTags(0)=(IconTag=">:(",IconTexture="SnMod.I_Mad")
	SmileyTags(1)=(IconTag=":(",IconTexture="SnMod.I_Frown")
	SmileyTags(2)=(IconTag=":)",IconTexture="SnMod.I_GreenLickB")
	SmileyTags(3)=(IconTag=":P",IconTexture="SnMod.I_Tongue",bCaseInsensitive=true)
	SmileyTags(4)=(IconTag=":d",IconTexture="SnMod.I_GreenLick")
	SmileyTags(5)=(IconTag=":D",IconTexture="SnMod.I_BigGrin")
	SmileyTags(6)=(IconTag=":|",IconTexture="SnMod.I_Indiffe")
	SmileyTags(7)=(IconTag=":/",IconTexture="SnMod.I_Ohwell")
	SmileyTags(8)=(IconTag=":*",IconTexture="SnMod.I_RedFace")
	SmileyTags(9)=(IconTag=":-*",IconTexture="SnMod.I_RedFace")
	SmileyTags(10)=(IconTag="Ban?",IconTexture="SnMod.I_Ban",bCaseInsensitive=true)
	SmileyTags(11)=(IconTag="B)",IconTexture="SnMod.I_Cool")
	SmileyTags(12)=(IconTag="Hmm",IconTexture="SnMod.I_Hmm")
	SmileyTags(13)=(IconTag="XD",IconTexture="SnMod.I_Scream")
	SmileyTags(14)=(IconTag="SPAM",IconTexture="SnMod.I_Spam")
}