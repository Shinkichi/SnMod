class Single extends KFMod.Single;
...
defaultproperties
{
	...
	FireModeClass(0)=Class'SnMod.SingleFire'
	FireModeClass(1)=Class'SnMod.SingleALTFire'
	PickupClass=Class'SnMod.SinglePickup'
	ItemName="9mm Tactical SN"
}
