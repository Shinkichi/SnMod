class ZombieFleshpoundBase extends SnMonster
    abstract;
...
defaultproperties
{
	...
	Health=1500//2000
	HealthMax=1500
	PlayerCountHealthScale=0//0.25
	PlayerNumHeadHealthScale=0//0.30 // Was 0.35 in Balance Round 1
	HeadHealth=600//700
